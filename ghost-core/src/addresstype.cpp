...
public:
    ...
    CScript operator()(const SilentPaymentDestination& sp) const
    {
        // Silent Payment destinations don't have a direct script representation.
        // The actual output scripts are derived P2TR addresses.
