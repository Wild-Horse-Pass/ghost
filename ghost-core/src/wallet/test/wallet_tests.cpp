...
BOOST_FIXTURE_TEST_CASE(BasicOutputTypesTest, ListCoinsTest)
{
    ...
    for (const auto& out_type : OUTPUT_TYPES) {
        ...
        // Skip SILENT_PAYMENT - it uses SilentPaymentScriptPubKeyMan and can't be tested
        // via GetNewDestination the same way as descriptor-based output types
        if (out_type == OutputType::SILENT_PAYMENT) continue;
