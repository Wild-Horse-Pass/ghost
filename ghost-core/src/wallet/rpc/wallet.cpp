...
std::span<const CRPCCommand> GetWalletRPCCommands()
{
    static const CRPCCommand commands[]{
        ...
        {"wallet", &derivesilentpaymentaddress},
        {"wallet", &checksilentpayment},
        {"wallet", &parseghostopreturn},
        {"wallet", &rescansilentpayments},
        {"wallet", &getsilentpaymentstats},
        // wraith protocol
        {"wallet", &createwraithtx},
        {"wallet", &createwraithfinaltx},
        {"wallet", &parsewraithtx},
        {"wallet", &shuffleoutputs},
        {"wallet", &createreconciliationtx},
        {"wallet", &coordinatebatchsigning},
        {"wallet", &combinebatchpsbt},
        {"wallet", &estimatebatchfee},
        {"wallet", &derivereconciliationoutputs},
    };
    return commands;
}
} // namespace wallet
