...
CTxDestination AddAndGetDestinationForScript(FlatSigningProvider& keystore, const CScript& script, OutputType type)
{
    ...
    case OutputType::SILENT_PAYMENT:  // Silent payments derive outputs differently, not from scripts
    case OutputType::UNKNOWN: {} // This function should not be used for BECH32M, SILENT_PAYMENT, or UNKNOWN
    } // no default case, so the compiler can warn about missing cases
    assert(false);
}
