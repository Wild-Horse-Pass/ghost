      ...
      platformStyle(_platformStyle)
{
    ...
    ghostGlyphPage = new GhostGlyphPage(platformStyle, this);
...
void WalletView::setL2WalletModel(L2WalletModel *l2Model)
{
    this->l2WalletModel = l2Model;
    overviewPage->setL2WalletModel(l2Model);
    if (ghostLocksPage) {
        ghostLocksPage->setL2WalletModel(l2Model);
    }
}
...
void WalletView::gotoGhostGlyphPage()
{
    setCurrentWidget(ghostGlyphPage);
}
