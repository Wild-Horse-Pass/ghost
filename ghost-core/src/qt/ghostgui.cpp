...
const std::string GhostGUI::DEFAULT_UIPLATFORM =
...
GhostGUI::GhostGUI(interfaces::Node& node, const PlatformStyle *_platformStyle, const NetworkStyle *networkStyle, QWidget *parent) :
    QMainWindow(parent),
    m_node(node),
    ...
    m_network_style(networkStyle)
{
    ...
    if(enableWallet)
    {
        ...
        connect(walletFrame, &WalletFrame::createWalletButtonClicked, this, &GhostGUI::createWallet);
    ...
    connect(labelBlocksIcon, &GUIUtil::ClickableLabel::clicked, this, &GhostGUI::showModalOverlay);
    connect(progressBar, &GUIUtil::ClickableProgressBar::clicked, this, &GhostGUI::showModalOverlay);
...
void GhostGUI::createActions()
{
    ...
    ghostLocksAction = new QAction(platformStyle->SingleColorIcon(":/icons/key"), tr("Ghost &Locks"), this);
    ghostLocksAction->setStatusTip(tr("Manage your L2 Ghost Locks"));
    ghostLocksAction->setToolTip(ghostLocksAction->statusTip());
    ghostLocksAction->setCheckable(true);
    ...
    withdrawAction = new QAction(tr("&Withdraw from L2..."), this);
    withdrawAction->setStatusTip(tr("Withdraw funds from Ghost Pay L2 to L1"));

#ifdef ENABLE_WALLET
    // These showNormalIfMinimized are needed because Send Coins and Receive Coins
    // can be triggered from the tray menu, and need to show the GUI to be useful.
    connect(overviewAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(overviewAction, &QAction::triggered, this, &GhostGUI::gotoOverviewPage);
    connect(sendCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(sendCoinsAction, &QAction::triggered, [this]{ gotoSendCoinsPage(); });
    connect(receiveCoinsAction, &QAction::triggered, [this]{ showNormalIfMinimized(); });
    connect(receiveCoinsAction, &QAction::triggered, this, &GhostGUI::gotoReceiveCoinsPage);
    ...
    connect(withdrawAction, &QAction::triggered, walletFrame, &WalletFrame::showWithdrawWizard);
#endif // ENABLE_WALLET
    ...
    m_load_psbt_action->setStatusTip(tr("Load Partially Signed Bitcoin Transaction (PSBT)"));
    m_load_psbt_clipboard_action = new QAction(tr("Load PSBT from &clipboard…"), this);
    m_load_psbt_clipboard_action->setStatusTip(tr("Load PSBT from clipboard"));
    ...
    showHelpMessageAction->setStatusTip(tr("Show the %1 help message to get a list with possible Ghost command-line options").arg(CLIENT_NAME));
    ...
    connect(quitAction, &QAction::triggered, this, &GhostGUI::quitRequested);
    connect(aboutAction, &QAction::triggered, this, &GhostGUI::aboutClicked);
    connect(aboutQtAction, &QAction::triggered, qApp, QApplication::aboutQt);
    connect(optionsAction, &QAction::triggered, this, &GhostGUI::optionsClicked);
    connect(showHelpMessageAction, &QAction::triggered, this, &GhostGUI::showHelpMessageClicked);
    connect(openRPCConsoleAction, &QAction::triggered, this, &GhostGUI::showDebugWindow);
    ...
    if(walletFrame)
    {
        ...
        connect(openAction, &QAction::triggered, this, &GhostGUI::openClicked);
        connect(m_open_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [path, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, path] {
                    ...
                    connect(activity, &OpenWalletActivity::opened, this, &GhostGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_restore_wallet_action, &QAction::triggered, [this] {
            ...
            connect(activity, &RestoreWalletActivity::restored, this, &GhostGUI::setCurrentWallet, Qt::QueuedConnection);
        ...
        connect(m_create_wallet_action, &QAction::triggered, this, &GhostGUI::createWallet);
        ...
        connect(m_migrate_wallet_menu, &QMenu::aboutToShow, [this] {
            ...
            for (const auto& [wallet_name, info] : m_wallet_controller->listWalletDir()) {
                ...
                connect(action, &QAction::triggered, [this, wallet_name] {
                    ...
                    connect(activity, &MigrateWalletActivity::migrated, this, &GhostGUI::setCurrentWallet);
        ...
        connect(m_mask_values_action, &QAction::toggled, this, &GhostGUI::setPrivacy);
        connect(m_mask_values_action, &QAction::toggled, this, &GhostGUI::enableHistoryAction);
    }
#endif // ENABLE_WALLET

    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_C), this), &QShortcut::activated, this, &GhostGUI::showDebugWindowActivateConsole);
    connect(new QShortcut(QKeySequence(Qt::CTRL | Qt::SHIFT | Qt::Key_D), this), &QShortcut::activated, this, &GhostGUI::showDebugWindow);
}

void GhostGUI::createMenuBar()
{
    appMenuBar = menuBar();
...
void GhostGUI::createToolBars()
{
    if(walletFrame)
    {
        ...
        connect(m_wallet_selector, qOverload<int>(&QComboBox::currentIndexChanged), this, &GhostGUI::setCurrentWalletBySelectorIndex);
...
void GhostGUI::setClientModel(ClientModel *_clientModel, interfaces::BlockAndHeaderTipInfo* tip_info)
{
    ...
    if(_clientModel)
    {
        ...
        connect(_clientModel, &ClientModel::numConnectionsChanged, this, &GhostGUI::setNumConnections);
        connect(_clientModel, &ClientModel::networkActiveChanged, this, &GhostGUI::setNetworkActive);
        ...
        connect(_clientModel, &ClientModel::numBlocksChanged, this, &GhostGUI::setNumBlocks);
        ...
        connect(_clientModel, &ClientModel::showProgress, this, &GhostGUI::showProgress);
...
#ifdef ENABLE_WALLET
void GhostGUI::enableHistoryAction(bool privacy)
{
...
void GhostGUI::setWalletController(WalletController* wallet_controller, bool show_loading_minimized)
{
    ...
    GUIUtil::ExceptionSafeConnect(wallet_controller, &WalletController::walletAdded, this, &GhostGUI::addWallet);
    connect(wallet_controller, &WalletController::walletRemoved, this, &GhostGUI::removeWallet);
...
WalletController* GhostGUI::getWalletController()
{
    return m_wallet_controller;
}

void GhostGUI::addWallet(WalletModel* walletModel)
{
    ...
    connect(wallet_view, &WalletView::outOfSyncWarningClicked, this, &GhostGUI::showModalOverlay);
    connect(wallet_view, &WalletView::transactionClicked, this, &GhostGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::coinsSent, this, &GhostGUI::gotoHistoryPage);
    connect(wallet_view, &WalletView::message, [this](const QString& title, const QString& message, unsigned int style) {
        this->message(title, message, style);
    });
    connect(wallet_view, &WalletView::encryptionStatusChanged, this, &GhostGUI::updateWalletStatus);
    connect(wallet_view, &WalletView::incomingTransaction, this, &GhostGUI::incomingTransaction);
    connect(this, &GhostGUI::setPrivacy, wallet_view, &WalletView::setPrivacy);
...
void GhostGUI::removeWallet(WalletModel* walletModel)
{
...
void GhostGUI::setCurrentWallet(WalletModel* wallet_model)
{
    if (!walletFrame || !m_wallet_controller) return;
...
void GhostGUI::setCurrentWalletBySelectorIndex(int index)
{
    WalletModel* wallet_model = m_wallet_selector->itemData(index).value<WalletModel*>();
    if (wallet_model) setCurrentWallet(wallet_model);
}

void GhostGUI::removeAllWallets()
{
    if(!walletFrame)
        return;
    setWalletActionsEnabled(false);
...
void GhostGUI::setWalletActionsEnabled(bool enabled)
{
...
void GhostGUI::createTrayIconMenu()
{
#ifndef Q_OS_MACOS
    if (!trayIcon) return;
#endif // Q_OS_MACOS
    ...
    show_hide_action = trayIconMenu->addAction(QString(), this, &GhostGUI::toggleHidden);
...
void GhostGUI::optionsClicked()
{
    openOptionsDialogWithTab(OptionsDialog::TAB_MAIN);
}

void GhostGUI::aboutClicked()
{
    if(!clientModel)
        return;
...
void GhostGUI::showDebugWindow()
{
    GUIUtil::bringToFront(rpcConsole);
    Q_EMIT consoleShown(rpcConsole);
}

void GhostGUI::showDebugWindowActivateConsole()
{
    rpcConsole->setTabFocus(RPCConsole::TabTypes::CONSOLE);
    showDebugWindow();
}

void GhostGUI::showHelpMessageClicked()
{
    GUIUtil::bringToFront(helpMessageDialog);
}

#ifdef ENABLE_WALLET
void GhostGUI::openClicked()
{
...
void GhostGUI::gotoOverviewPage()
{
    overviewAction->setChecked(true);
    if (walletFrame) walletFrame->gotoOverviewPage();
}

void GhostGUI::gotoHistoryPage()
{
    historyAction->setChecked(true);
    if (walletFrame) walletFrame->gotoHistoryPage();
}

void GhostGUI::gotoReceiveCoinsPage()
{
    receiveCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoReceiveCoinsPage();
}

void GhostGUI::gotoSendCoinsPage(QString addr)
{
    sendCoinsAction->setChecked(true);
    if (walletFrame) walletFrame->gotoSendCoinsPage(addr);
}

void GhostGUI::gotoSignMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoSignMessageTab(addr);
}

void GhostGUI::gotoVerifyMessageTab(QString addr)
{
    if (walletFrame) walletFrame->gotoVerifyMessageTab(addr);
}
void GhostGUI::gotoLoadPSBT(bool from_clipboard)
{
    if (walletFrame) walletFrame->gotoLoadPSBT(from_clipboard);
}

void GhostGUI::gotoGhostLocksPage()
{
...
void GhostGUI::updateNetworkState()
{
    ...
    if (m_node.getNetworkActive()) {
        ...
        tooltip = tr("%n active connection(s) to Ghost network.", "", count);
    } else {
        //: A substring of the tooltip.
...
void GhostGUI::setNumConnections(int count)
{
    updateNetworkState();
}

void GhostGUI::setNetworkActive(bool network_active)
{
    updateNetworkState();
...
void GhostGUI::updateHeadersSyncProgressLabel()
{
...
void GhostGUI::updateHeadersPresyncProgressLabel(int64_t height, const QDateTime& blockDate)
{
...
void GhostGUI::openOptionsDialogWithTab(OptionsDialog::Tab tab)
{
    if (!clientModel || !clientModel->getOptionsModel())
        return;

    auto dlg = new OptionsDialog(this, enableWallet);
    connect(dlg, &OptionsDialog::quitOnReset, this, &GhostGUI::quitRequested);
...
void GhostGUI::setNumBlocks(int count, const QDateTime& blockDate, double nVerificationProgress, SyncType synctype, SynchronizationState sync_state)
{
...
void GhostGUI::createWallet()
{
#ifdef ENABLE_WALLET
    auto activity = new CreateWalletActivity(getWalletController(), this);
    connect(activity, &CreateWalletActivity::created, this, &GhostGUI::setCurrentWallet);
    connect(activity, &CreateWalletActivity::created, rpcConsole, &RPCConsole::setCurrentWallet);
    activity->create();
#endif // ENABLE_WALLET
}

void GhostGUI::message(const QString& title, QString message, unsigned int style, bool* ret, const QString& detailed_message)
{
...
void GhostGUI::changeEvent(QEvent *e)
{
    ...
    if(e->type() == QEvent::WindowStateChange)
    {
        if(clientModel && clientModel->getOptionsModel() && clientModel->getOptionsModel()->getMinimizeToTray())
        {
            ...
            {
                QTimer::singleShot(0, this, &GhostGUI::hide);
                e->ignore();
            }
            else if((wsevt->oldState() & Qt::WindowMinimized) && !isMinimized())
            {
                QTimer::singleShot(0, this, &GhostGUI::show);
                e->ignore();
            }
        }
    }
...
void GhostGUI::closeEvent(QCloseEvent *event)
{
#ifndef Q_OS_MACOS // Ignored on Mac
    if(clientModel && clientModel->getOptionsModel())
    {
...
void GhostGUI::showEvent(QShowEvent *event)
{
...
#ifdef ENABLE_WALLET
void GhostGUI::incomingTransaction(const QString& date, BitcoinUnit unit, const CAmount& amount, const QString& type, const QString& address, const QString& label, const QString& walletName)
{
...
void GhostGUI::dragEnterEvent(QDragEnterEvent *event)
{
    // Accept only URIs
...
void GhostGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool GhostGUI::eventFilter(QObject *object, QEvent *event)
{
...
#ifdef ENABLE_WALLET
bool GhostGUI::handlePaymentRequest(const SendCoinsRecipient& recipient)
{
    // URI has to be valid
...
void GhostGUI::setHDStatus(bool privkeyDisabled, int hdEnabled)
{
...
void GhostGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void GhostGUI::updateWalletStatus()
{
    assert(walletFrame);
...
void GhostGUI::updateWindowTitle()
{
...
void GhostGUI::showNormalIfMinimized(bool fToggleHidden)
{
    if(!clientModel)
        return;
...
void GhostGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void GhostGUI::detectShutdown()
{
...
void GhostGUI::showProgress(const QString &title, int nProgress)
{
    if (nProgress == 0) {
...
void GhostGUI::showModalOverlay()
{
    if (modalOverlay && (progressBar->isVisible() || modalOverlay->isLayerVisible()))
        modalOverlay->toggleVisibility();
}

static bool ThreadSafeMessageBox(GhostGUI* gui, const bilingual_str& message, const std::string& caption, unsigned int style)
{
    ...
    if (message.original != message.translated) {
        detailed_message = GhostGUI::tr("Original message:") + "\n" + QString::fromStdString(message.original);
    }
...
void GhostGUI::subscribeToCoreSignals()
{
...
void GhostGUI::unsubscribeFromCoreSignals()
{
...
bool GhostGUI::isPrivacyModeActivated() const
{
