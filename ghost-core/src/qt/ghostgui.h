...
#ifndef GHOST_QT_GHOSTGUI_H
#define GHOST_QT_GHOSTGUI_H
...
/**
  Ghost GUI main class. This class represents the main window of the Ghost UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class GhostGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit GhostGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~GhostGUI();
...
public Q_SLOTS:
    ...
    /** Load Partially Signed Bitcoin Transaction (PSBT) from file or clipboard */
