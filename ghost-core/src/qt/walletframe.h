...
#ifndef GHOST_QT_WALLETFRAME_H
#define GHOST_QT_WALLETFRAME_H
 ...
 * controls into GhostGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to GhostGUI, thus greatly simplifying merges while
...
public Q_SLOTS:
    ...
    void showWithdrawWizard();
};

#endif // GHOST_QT_WALLETFRAME_H
