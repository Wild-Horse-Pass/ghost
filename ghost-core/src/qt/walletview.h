...
#ifndef GHOST_QT_WALLETVIEW_H
#define GHOST_QT_WALLETVIEW_H
...
public:
    ...
    */
    ...
    /** Set the L2 wallet model for Ghost Pay integration */
    void setL2WalletModel(L2WalletModel *l2Model);

    WalletModel* getWalletModel() const noexcept { return walletModel; }
    L2WalletModel* getL2WalletModel() const noexcept { return l2WalletModel; }
...
private:
    ...
    //! The L2 wallet model for Ghost Pay integration
