...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    // Ghost/Wraith Protocol RPCs
    { "createwraithtx", 0, "inputs" },
    { "createwraithtx", 1, "intermediate_outputs" },
    { "createwraithtx", 5, "mining_fee" },
    { "createwraithfinaltx", 0, "inputs" },
    { "createwraithfinaltx", 1, "outputs" },
    { "createwraithfinaltx", 4, "mining_fee" },
    { "createreconciliationtx", 0, "inputs" },
    { "createreconciliationtx", 1, "outputs" },
    { "createreconciliationtx", 2, "epoch_id" },
    { "createreconciliationtx", 5, "treasury_amount" },
    { "checksilentpayment", 2, "index" },
    { "checksilentpayment", 3, "nonce" },
    { "derivesilentpaymentaddress", 1, "index" },
    { "derivesilentpaymentaddress", 2, "nonce" },
    { "derivereconciliationoutputs", 0, "recipients" },
    { "derivereconciliationoutputs", 1, "nonce" },
    { "rescansilentpayments", 0, "start_height" },
    { "rescansilentpayments", 1, "stop_height" },
    { "estimatebatchfee", 0, "num_inputs" },
    { "estimatebatchfee", 1, "num_outputs" },
    { "estimatebatchfee", 2, "include_treasury" },
    { "estimatebatchfee", 3, "conf_target" },
    { "estimatebatchfee", 4, "fee_rate" },
    { "shuffleoutputs", 1, "keep_last" },
    { "coordinatebatchsigning", 1, "utxos" },
    { "combinebatchpsbt", 0, "psbts" },
};
// clang-format on
