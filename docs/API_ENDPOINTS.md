...
| Method | Endpoint | Description |
|--------|----------|-------------|
| GET | `/api/v1/mining/status` | Mining status (includes `pool_name`) |
...
| POST | `/api/v1/mining/payout_address` | Set mining payout address |
| POST | `/api/v1/mining/pool_name` | Set custom pool name for coinbase tag |
