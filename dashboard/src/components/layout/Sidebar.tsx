...
export function Sidebar() {
  ...
  return (
    <aside
      className={`
        flex flex-col border-r border-gray-800 bg-gray-900/50 transition-all duration-300 ease-in-out
        ${collapsed ? 'w-16' : 'w-64'}
      `}
    >
      {/* Header */}
        ...
        {collapsed ? (
          ...
          <div className="flex items-center gap-2">
            ...
            <div className="flex flex-col">
              ...
              {nickname && (
                <span className="text-xs text-gray-500 truncate max-w-32">{nickname}</span>
              )}
            </div>
          </div>
        )}
      ...
      <nav className="flex-1 p-2 space-y-1 overflow-y-auto">
        ...
        <SidebarGroup
          ...
          collapsed={collapsed}
          items={[
            { href: '/operator/swarm', label: 'Swarm' },
            { href: '/operator/mesh', label: 'Mesh' },
            { href: '/operator/rewards', label: 'Rewards' },
            { href: '/operator/migration', label: 'Migration' },
          ]}
        />
        ...
        <SidebarItem href="/buds" icon={<BudsIcon />} label="BUDS" collapsed={collapsed} />
        <SidebarItem href="/storage" icon={<StorageIcon />} label="Storage" collapsed={collapsed} />

        <div className="pt-2 border-t border-gray-800 mt-2" />

        <SidebarItem href="/updates" icon={<UpdatesIcon />} label="Updates" collapsed={collapsed} />
